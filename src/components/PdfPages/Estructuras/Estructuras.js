...
export const printEstructuras = (parent) => {
    ...
    <p>Journal figure from review: <strong><em>Viruses.</em></strong> 2015 Aug; 7(8): 4461-4481: doi:10.3390/v7082826</p>
    ...
    <p>(C) Multiple sequence Alignment of p7 proteins and schematic representation of structured regions.</p>
