...
export const printFunciones = (parent) => {
    ...
    const mainFunciones = document.createElement('main')
        ...
        printReview('Review',  'Viroporins:', 'Structure and biological functions', 'Published in (Journal/Editorial):' ,mainFunciones, 'violet', '/medioFunciones.png')
        ...
        <p>Visual concept and sketch for figure desing and ilustration in: <strong>Nature Reviews Microbiology.</strong></p> 
        <p>2012 Jul 2;10(8):563-74.doi:10.1038/nrmicro2820.</p>
        ...
        <p>Sketch created by Vanesa Madan. Digital ilustration created by Nature creative team.</p>
