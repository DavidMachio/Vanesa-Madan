...
export const printConection = (parent) => {
    ...
    const mainConection = document.createElement('main')
        ...
        <p>Glycosilation sites in E1 and E2 are depicted as sugar chains.</p>
        ...
        <div class='contenedortextos'>
        <p><strong>RNA Biology.</strong> 2011. 8:2, 258-269, DOI: 10.4161/rna.8.2.15011.</p>
        ...
        <p>(4) HCV genome replication at the membranous web (virus-induced vesicles in black).</p>
