...
export const printReplication = (parent) => {
        ...
        <p>The single-strnad (ss) HCV RNA genome is shown on the top.</p>
        <p>The viral polyprotein is represented in yellow.</p>
        <p>The cleavage of the viral poluprotein by cellular (SPP and SP) and viral proteases (NS4 and NS3/4A) is indicated by scissors.</p>
        ...
        <div class='contenedortextos'>
        <p><strong>Figure 2.</strong> Model of Hepatitis C Virus-Induced Double-Membrane Vesicle (left) and Hypotetical 3D Structures of Membrane-Associated Hepatitis C virus proteins (in boxes)</p>
        ...
        <p>(A) Hypothenical model of Hepatitis C virus assembly (left side).</p>
        <p>Viral RNA (HCV RNA in red) is shutlle from replication sites to cytosolic lipid droplets.</p>
        ...
        <p>In the two particle model, lipidation occurs during virus eggress via interaction between the virion and lipoprotein perticles</p>
